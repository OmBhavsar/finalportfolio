        ...
        <div ref={ref} className={`contact-content reveal ${isActive ? 'active' : ''}`}>
          ...
          <div className="contact-info">
            ...
            <div className="contact-links">
              <a href="mailto:bhavsarom932@gmail.com" className="contact-item glass-panel">
                <Mail className="c-icon" />
                <span>bhavsarom932@gmail.com</span>
              </a>
            ...
            <div className="social-links-lg">
              ...
              <a href="https://www.instagram.com/om.bhavsar28/" target="_blank" rel="noreferrer" className="social-btn glass-panel">
